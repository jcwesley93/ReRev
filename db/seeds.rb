...
###AUTHORS 
# john = Author.create(name: "John Doe", email: "john@test.com", pen_name: "John Anon", password: "password")
# jane = Author.create(name: "Jane Doe", email: "jane@test.com", pen_name: "Jane Anon", password: "password")
# jill = Author.create(name: "Jill Doe", email: "jill@test.com", pen_name: "Jill Anon", password: "password")
# james = Author.create(name: "James Doe", email: "james@test.com", pen_name: "james Anon", password: "password")
# jasmine = Author.create(name: "Jasmine Doe", email: "jasmine@test.com", pen_name: "Jasmine Anon", password: "password")
# jacob = Author.create(name: "Jacob Doe", email: "jacob@test.com", pen_name: "Jacob Anon", password: "password")
